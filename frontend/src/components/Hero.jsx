...
const Hero = () => {
  return (
    <section className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[711px] w-full relative'>
        <div className="pt-44 xl:pt-52 max-w-[677px] text-white">
          <span className="px-3 ring-1 ring-white/30 max-w-72 rounded-3xl"><span className="text-secondary">#1</span> Trusted Donation & Charity Platform</span>
          <h1 className="h1 max-w-[44rem] mt-6">
            Empower Lives with Your Donations and Support Charitable Causes
          </h1>
          <p className="text-gray-10">
            Join hands with us to support underprivileged communities, provide healthcare, food, education, and more through your generous donations.
          </p>
          <div className="mt-8">
            <Link to={"/login"} className="btn-light !bg-transparent !ring-white !py-3">
              Register Now
            </Link>
            <Link to={"/donate"} className="btn-secondary !text-tertiary !py-3 ml-3">
              Donate Now
            </Link>
          </div>
        </div>
